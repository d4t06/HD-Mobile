...
function ProductConfig({ attrList }: Props, ref: Ref<ConfigRef>) {
   const { combines_data, product_name_ascii, product_name, sliders_data, setIsChange, colors_data, storages_data } =
      useProductContext();
