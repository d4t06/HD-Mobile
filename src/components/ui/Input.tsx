...
export const inputClasses = {
  input: "p-[6px] font-[500] text-[#333] pl-[12px] bg-[#f1f1f1] w-full h-full rounded-[12px] placeholder:text-[#808080] outline-none border border-black/10 text-[16px] translate-y-[-4px]",
};
